...
async def analyze_task_with_ai(task_description: str) -> TaskAnalysis:
    ...
    prompt = (
        ...
        '  "summary" — суть обращения, опиши, что случилось и что нужно сделать. Не удаляй Имена, телефоны, названия компаний, telegram теги @user_name. (2-4 предложения, до 300 символов).\n'
